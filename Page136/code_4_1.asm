...
;Sample execution: 
;TYPE A BINARY NUMBER, UP TO 8 DIGITS: 1111
;IN HEX IT IS E1

.MODEL SMALL
.STACK 100H
.DATA
    PROMPT_MSG DB 'TYPE A BINARY NUMBER, UP TO 8 DIGITS: $'
    HEX_MSG DB 0DH, 0AH, 'IN HEX IT IS $'
    ERROR_MSG DB 0DH, 0AH, 'INVALID CHARACTER! PLEASE TRY AGAIN.', 0DH, 0AH, '$'
    NEWLINE DB 0DH, 0AH, '$'
    BINARY_BUFFER DB 9 DUP(0)  ; Buffer to store binary digits + null terminator
